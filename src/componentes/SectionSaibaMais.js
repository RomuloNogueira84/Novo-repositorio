...
function SectionSaibaMais() {
  const estilo = { padding: "10px" };

  return (
    <section>
      {/*Inicio do Componente Acordeão*/}
      <Accordion id="saibaMais" style={{ zIndex: "-1!important" }}>
        ...
        <Accordion.Item eventKey="0">
          ...
          {/*Corpo do componente acordeão*/}
          <Accordion.Body>
            <u> Pré-requisitos para cursos de desenvolvimento web Front-end</u><br/>{" "}
            ...
            <br />
            <b>Explicação:</b> Os pré-requisitos para os cursos de
            desenvolvimento web são projetados para garantir que os alunos
            tenham as habilidades e conhecimentos necessários para ter sucesso
            no curso. Para o curso de front-end, os alunos devem ter um
            conhecimento básico de HTML, CSS e JavaScript. Esses são os
            principais fundamentos do desenvolvimento web front-end. Os alunos
            também devem ter um interesse em design e usabilidade, pois esses
            são aspectos importantes do desenvolvimento web front-end.
            <br />
            <hr />
            ...
            linguagem de programação back-end, como Python, Java ou PHP
            ...
            Java ou PHP. Essas são as principais linguagens de programação
            usadas para desenvolvimento web back-end.
            <hr />
            ...
            alunos devem ter a capacidade de trabalhar de forma independente e
            em equipe, bem como a capacidade de aprender rapidamente novas
            tecnologias.
            <hr />
            ...
            eles podem precisar trabalhar mais duro para acompanhar os alunos
            que já possuem os pré-requisitos. Os alunos que não atendem a todos
            os pré-requisitos podem considerar fazer cursos online ou tutoriais
            para aprender os conceitos necessários. Eles também podem considerar
        ...
        <Accordion.Item eventKey="1">
          ...
          <Accordion.Body>
            ...
            cada. Cada módulo inclui uma avaliação teórica e uma prática. O
            curso tem aulas semanais de 2 horas, com avaliações teóricas ao
            final de cada módulo e avaliações práticas ao final do curso.
          </Accordion.Body>
        </Accordion.Item>
        {/*Item do Acordeão*/}
            ...
            <div id="professores">
              ...
              <Card style={{ width: "18rem" }}>
                ...
                <Card.Body>
                  ...
                  <Card.Text>
                    ...
                    faço análise de requisitos, modelagem de processos de
                    negócio, realizando atendimento de casos de primeiro e
                    segundo nível.
                  </Card.Text>
                </Card.Body>
              </Card>
              ...
              <Card style={{ width: "18rem" }}>
                ...
                <Card.Body>
                  ...
                  <Card.Text>
                    ...
                    , JavaScript , Spring, Angular e React. Além disso
                    familiarizado com banco de dado relacionail e técnicas de
              ...
              <Card style={{ width: "18rem" }}>
                ...
                <Card.Body>
                  ...
                  <Card.Text>
                    Experiente DBA sênior com histórico comprovado de trabalho
                    no setor de tecnologia da informação e serviços. Hábil em
                    banco de dados Oracle, análise de sistemas e gerenciamento
                    de serviços de TI.
                  </Card.Text>
                </Card.Body>
              </Card>
